...
export const DeployWorkflowItemSchema = z
  .object({
    name: z.string().optional().describe(
      "Optional stable workflow name. When provided, any existing active workflow with this name " +
      "is deprecated and replaced by the new one. When omitted, a name is auto-generated."
    ),
...
export const DeployWorkflowResultSchema = z
  .object({
    ...
    upgradedFrom: z.string().uuid().nullable().optional().describe(
      "If action is 'created' and a previous active workflow with the same name existed, " +
      "this is the ID of that workflow (now deprecated)."
    ),
  })
